    ...
    switch (role) {
      case MissionUiRole.client:
        return switch (status) {
          ...
          MissionStatus.completed => 'Paye',
          MissionStatus.paymentHeld => 'Paye',
          MissionStatus.awaitingRelease => 'Paye',
          MissionStatus.closed => 'Paye',
      ...
      case MissionUiRole.freelancer:
        return switch (status) {
          ...
          MissionStatus.completed => 'Argent bloque',
          MissionStatus.paymentHeld => 'Argent bloque',
          MissionStatus.awaitingRelease => 'Recevoir sous 24h',
          MissionStatus.closed => 'Paiement recu',
          MissionStatus.cancelled => 'Annulee',
