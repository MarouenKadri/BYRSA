              ...
              Row(
                ...
                children: [
                  Row(children: [
                    ...
                    AppGap.w10,
                    Text('Prestataire', style: context.text.bodyMedium?.copyWith(fontWeight: FontWeight.w500)),
                  ]),
                  Text('${presta.round()} €', style: context.text.titleMedium?.copyWith(fontWeight: FontWeight.w700, color: AppColors.primary)),
                ],
              ),
              Padding(
                ...
                child: Row(children: [
                  ...
                  Padding(
                    ...
                    child: Icon(Icons.add_rounded, size: 14, color: context.colors.textHint),
                  ),
                  Expanded(child: Divider(color: context.colors.divider)),
                ]),
              ),
              Row(
                ...
                children: [
                  Row(children: [
                    Container(
                      padding: AppInsets.a8,
                      decoration: BoxDecoration(color: context.colors.surfaceAlt, borderRadius: BorderRadius.circular(AppRadius.small)),
                      child: Icon(Icons.eco_rounded, size: 16, color: context.colors.textSecondary),
                    ),
                    AppGap.w10,
                    Text('Commission Inkern (10%)', style: context.text.bodyMedium?.copyWith(fontWeight: FontWeight.w500)),
                  ]),
                  Text('${cigale.round()} €', style: context.text.bodyMedium?.copyWith(fontWeight: FontWeight.w600)),
                ],
              ),
              AppGap.h12,
              Container(
                ...
                child: Row(children: [
                  ...
                  Expanded(child: Text(
                    ...
                    style: context.text.labelMedium?.copyWith(color: AppColors.secondary, height: 1.3),
                  )),
                ]),
              ),
            ],
      ...
      children: [
            ...
            children: [
              ...
              Expanded(
                child: TextField(
                  ...
                  style: context.text.displaySmall?.copyWith(fontSize: AppFontSize.h1Lg),
                  decoration: InputDecoration(
                    hintText: '0',
                    hintStyle: context.text.displaySmall?.copyWith(fontSize: AppFontSize.h1Lg, color: context.colors.border),
        ...
        Container(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text('Budget estimé', style: context.text.titleSmall?.copyWith(color: AppColors.primary)),
              Text(
                '${(widget.hourlyRate * widget.estimatedHours).round()} €',
                style: context.text.headlineLarge?.copyWith(fontWeight: FontWeight.w800, color: AppColors.primary),
              ),
            ],
          ),
        ),
      ...
      children: [
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              hintText: '0',
              hintStyle: context.text.bodyMedium?.copyWith(color: context.colors.border),
              prefixIcon: Padding(
                padding: const EdgeInsets.only(left: 16, right: 8),
                child: Text('€', style: context.text.displaySmall?.copyWith(fontWeight: FontWeight.w700, color: AppColors.primary)),
              ),
          ...
          children: [50, 100, 150, 200, 300].map((amount) {
            return GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(color: context.colors.surfaceAlt, borderRadius: BorderRadius.circular(AppRadius.badge)),
                child: Text('${amount}€', style: context.text.bodyMedium?.copyWith(fontWeight: FontWeight.w600)),
              ),
            );
          }).toList(),
        ),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        padding: AppInsets.a16,
        decoration: BoxDecoration(
          color: isSelected ? AppColors.primary.withOpacity(0.1) : context.colors.surface,
          borderRadius: BorderRadius.circular(AppRadius.button),
          border: Border.all(
