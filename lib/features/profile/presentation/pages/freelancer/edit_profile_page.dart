  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppPageAppBar(
        ...
        titleWidget: Text('Modifier mon profil', style: context.profilePageTitleStyle),
        centerTitle: true,
        bottom: isFreelancer
            ? PreferredSize(
                ...
                child: Container(
                  ...
                  child: CigaleTabBar(
                    ...
                    tabs: const [
                      ...
                      CigaleTab(icon: Icons.trending_up_rounded, label: 'Activité'),
                    ],
                  ),
                ),
              )
          ...
          child: Row(children: [
            ...
            Expanded(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('Compte vérifié',
                    style: context.text.bodyMedium?.copyWith(fontWeight: FontWeight.w700, color: AppColors.primary)),
                AppGap.h2,
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Container(
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: _searchFocus.hasFocus ? AppColors.primary : context.colors.border,
        ...
        if (_displayAddress.isNotEmpty) ...[
          ...
          Container(
            ...
            child: Row(children: [
              ...
              Expanded(
                child: Text(
                  _displayAddress,
                  style: context.text.bodySmall?.copyWith(fontWeight: FontWeight.w600, color: AppColors.primary),
                  maxLines: 2,
                  overflow: TextOverflow.ellipsis,
                ),
              ),
          ...
          Container(
            ...
            child: Row(children: [
              Icon(Icons.info_outline_rounded, size: 15, color: context.colors.textHint),
              AppGap.w8,
    ...
    return AppSurfaceCard(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          AppGap.w8,
          Text(label, style: context.text.bodySmall?.copyWith(fontWeight: FontWeight.w700, color: color)),
          const Spacer(),
          Text('$score%', style: context.text.titleMedium?.copyWith(fontWeight: FontWeight.w800, color: color)),
        ]),
        AppGap.h10,
        ClipRRect(
          borderRadius: BorderRadius.circular(AppRadius.full),
        ...
        if (score < 100) ...[
          ...
          Text(
            ...
            style: context.text.labelMedium?.copyWith(color: color.withValues(alpha:0.8), height: 1.4),
          ),
        ],
      ]),
    );
    ...
    return _SectionCard(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        TextField(
          ...
          style: context.text.bodyMedium?.copyWith(color: context.colors.textPrimary, height: 1.6),
          decoration: InputDecoration(
            hintText: 'Ex : Professionnel ponctuel et sérieux…',
            hintStyle: context.text.bodySmall?.copyWith(color: context.colors.textHint, height: 1.5),
            counterText: '',
            filled: true, fillColor: context.colors.surface,
            border: OutlineInputBorder(borderRadius: BorderRadius.circular(AppRadius.input), borderSide: BorderSide(color: context.colors.border)),
            enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(AppRadius.input), borderSide: BorderSide(color: context.colors.border)),
    ...
    return _SectionCard(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        TextField(
          ...
          style: TextStyle(fontSize: AppFontSize.h1Lg, fontWeight: FontWeight.w800, color: context.colors.textPrimary),
          decoration: InputDecoration(
            hintText: '25',
            hintStyle: TextStyle(fontSize: AppFontSize.h1Lg, fontWeight: FontWeight.w800, color: context.colors.border),
            ...
            suffixText: '€ / heure',
            suffixStyle: context.text.bodyMedium?.copyWith(fontWeight: FontWeight.w600),
            filled: true, fillColor: context.colors.surface,
            enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(AppRadius.input), borderSide: BorderSide(color: context.colors.border)),
            focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(AppRadius.input), borderSide: const BorderSide(color: AppColors.primary, width: 1.8)),
    ...
    return _SectionCard(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        AppSurfaceCard(
          ...
          child: Row(children: [
            ...
            Text('${zoneRadius.toInt()} km',
                style: context.text.titleSmall?.copyWith(fontWeight: FontWeight.w800, color: AppColors.primary)),
          ]),
        ),
        SliderTheme(
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Text('5 km',   style: context.text.labelSmall?.copyWith(color: context.colors.textHint)),
          Text('100 km', style: context.text.labelSmall?.copyWith(color: context.colors.textHint)),
        ]),
      ]),
    );
  }
...
class _InfoBanner extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => AppInfoBanner(icon: icon, message: text, color: color);
}
  ...
  Widget build(BuildContext context) => Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        AppSurfaceCard(
          ...
          child: Row(children: [
            ...
            AppGap.w10,
            Expanded(child: Text(value, style: context.text.bodyMedium?.copyWith(color: context.colors.textTertiary))),
