...
final _freelancerReceivedReviews = [
  Review(
    ...
    missionId: 'm1',
    missionTitle: 'Réparation fuite d\'eau',
  ...
  Review(
    ...
    missionId: 'm2',
    missionTitle: 'Installation prise électrique',
  ...
  Review(
    ...
    missionId: 'm3',
    missionTitle: 'Montage cuisine IKEA',
...
final _freelancerGivenReviews = [
  Review(
    ...
    satisfaction: Satisfaction.tresSatisfait,
    comment:
        'Cliente très agréable, maison propre et consignes claires. Paiement rapide.',
    missionId: 'm1',
    missionTitle: 'Réparation fuite d\'eau',
